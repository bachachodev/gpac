...
<!--nav left-->
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li <?php if ($nombre_archivo == $url_practicas):?>class="active"<?php endif;?>>
        	<a href="<?php echo $url_practicas ?>">
        	<span class="glyphicon glyphicon-pencil"></span> Prácticas
            </a>
        </li>
		...
		<li class="dropdown-submenu">
			...
			<ul class="dropdown-menu">
				...
				<li>
					...
					<span class="pull-right hidden-xs showopacity glyphicon glyphicon-briefcase"></span> Usuario
                    </a>
                </li>
				<?php endif; ?>
				<li>
