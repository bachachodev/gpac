...
if (isset($_POST[$MM_flag])) {
  $MM_dupKeyRedirect="especialidadAdd.php";
  $loginUsername = $_POST['codigo'];
  $LoginRS__query = sprintf("SELECT espeCodigo FROM especialidad WHERE espeCodigo=%s", GetSQLValueString($loginUsername, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "agregar")) {
  $insertSQL = sprintf("INSERT INTO especialidad (espeCodigo, espeNombre, espeVigencia) VALUES (%s, %s, %s)",
      ...
      <div class="panel-body">
        ...
        <!--tab content-->
            ...
            <span class="input-group-addon" style="width:90px"><span class="glyphicon glyphicon-barcode" style="color:orange"></span></span>
              <input type="text" name="codigo" id="codigo" value="" class="form-control" placeholder="Código Especialidad" autofocus onfocus="this.value=''" autocomplete="off" required>
            </div>
            <div class="form-group input-group" style="width:100%;">
              <span class="input-group-addon" style="width:90px"><span class="glyphicon glyphicon-file"></span></span>
              <input type="text" name="especialidad" id="especialidad" value="" class="form-control" placeholder="Nombre Especialidad" autofocus onfocus="this.value=''" autocomplete="off">
            </div>
