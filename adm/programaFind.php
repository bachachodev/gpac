...
mysql_select_db($database_rsPP, $rsPP);
$query_rsEdit = "SELECT * FROM programa";
...
<div class="container col-md-6 col-md-offset-3">
  ...
  <tr>
    <td><?php if ($_SERVER['QUERY_STRING'] == "edit") : ?>
      <a href="programaEdit.php?progCodigo=<?php echo $row_rsEdit['progCodigo']; ?>" data-toggle="tooltip" data-placement="top" title="Editar" onclick="submitForm()"><span class="glyphicon glyphicon-pencil"></span></a>
      <?php endif; ?>
      <?php if ($_SERVER['QUERY_STRING'] == "del") : ?>
      <a href="programaDel.php?progCodigo=<?php echo $row_rsEdit['progCodigo']; ?>" data-toggle="tooltip" data-placement="top" title="Editar" onclick="submitForm()"><span class="glyphicon glyphicon-remove"></span></a>
      <?php endif; ?>
    <td><?php echo $row_rsEdit['progCodigo']; ?></td>
    <td><?php echo $row_rsEdit['progNombre']; ?></td>
    <td><?php echo $row_rsEdit['progAreaAcademica']; ?></td>
    <td><span class="glyphicon <?php if (($row_rsEdit['progVigencia']) == 1) { echo "glyphicon-ok"; } else { echo "glyphicon-remove";} ?>" style="text-align:center; color:<?php if (($row_rsEdit['progVigencia']) == 1) { echo "#0C0"; } else { echo "#F00";} ?>"></span></td>
  </tr>
