...
mysql_select_db($database_rsPP, $rsPP);
$query_rsSeccion = "SELECT * FROM asignatura INNER JOIN seccion ON asignatura.asigCodigo = seccion.asigCodigo INNER JOIN especialidad ON seccion.espeCodigo = especialidad.espeCodigo ORDER BY asignatura.asigCodigo ASC";
