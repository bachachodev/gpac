...
if ((isset($_POST['progID'])) && ($_POST['progID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM programa WHERE progID=%s",
      ...
      <div class="panel-body">
        ...
        <!--tab content-->
            ...
            <div class="form-group input-group" style="width:100%;">
              ...
              <input type="text" name="nomPrograma" id="nomPrograma" value="<?php echo $row_rsEdit['progNombre']; ?>" class="form-control" placeholder="Nombre Programa" autofocus autocomplete="off" disabled>
            </div>
            <div class="form-group input-group" style="width:100%">
              <span class="input-group-addon" style="width:90px"><span class="glyphicon glyphicon-education"></span></span>
              <input type="text" name="areaAcademica" id="areaAcademica" value="<?php echo $row_rsEdit['progAreaAcademica']; ?>" class="form-control" placeholder="Area Académica" autofocus autocomplete="off" disabled>
            </div>
            <div class="checkbox checkbox-warning">
            <input name="vigencia" type="checkbox" class="styled" id="vigencia" value="1" <?php if (!(strcmp($row_rsEdit['progVigencia'],1))) {echo "checked=\"checked\"";} ?> disabled>
