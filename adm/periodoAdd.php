...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "agregar")) {
  $insertSQL = sprintf("INSERT INTO periodo (periCodigo, periAgno, periSemestre, periTexto, periVigencia) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($codPeriodo, "text"),
                       GetSQLValueString($_POST['agno'], "int"),
                       GetSQLValueString($_POST['semestre'], "int"),
                       GetSQLValueString($descPeriodo, "text"),
      ...
      <div class="panel-body">
        ...
        <!--tab content-->
            <div class="form-group input-group" style="width:100%;">
              ...
              <input type="text" name="agno" id="agno" value="" class="form-control" placeholder="Año" autofocus autocomplete="off" required/>
            </div>
            <div class="form-group input-group" style="width:100%">
            <span class="input-group-addon" style="width:90px"><span class="glyphicon glyphicon-tag" style="color:orange"></span></span>
            <select name="semestre" id="semestre" class="form-control" title="Semestre" required/>
              <option disabled selected value="">Semestre</option>
              <option value="1">1° Semestre (Otoño)</option>
              <option value="2">2° Semestre (Primavera)</option>
              <option value="3">3° Semestre (Verano)</option>
            </select>
            </div>
