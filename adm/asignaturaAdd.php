...
if (isset($_POST[$MM_flag])) {
  $MM_dupKeyRedirect="asignaturaAdd.php";
  $loginUsername = $_POST['codigo'];
  $LoginRS__query = sprintf("SELECT asigCodigo FROM asignatura WHERE asigCodigo=%s", GetSQLValueString($loginUsername, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "agregar")) {
  $insertSQL = sprintf("INSERT INTO asignatura (asigCodigo, asigTipo, asigNombre, asigVigencia, progCodigo) VALUES (%s, %s, %s, %s, %s)",
...
<div class="container-fluid" style="z-index:-1">
  ...
  if (isset($requsername)) : ?>
    <div Id="contAlert" class="alert alert-danger fade in" align="center" role="alert">
      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
      <span class="glyphicon glyphicon-remove" aria-hidden="true" style="font-size:22px; vertical-align:middle"></span>Código de Asignatura<strong></strong> ya existe
    </div>
  <?php endif; ?>
        ...
        <!--tab content-->
            <div class="form-group input-group" style="width:100%">
              ...
              <select name="programa" id="programa" class="form-control" title="Programa" required/>
				...
				do {  
				?>
                <option value="<?php echo $row_rsPrograma['progCodigo']?>"><?php echo $row_rsPrograma['progCodigo']?> <?php echo $row_rsPrograma['progNombre']?></option>
				<?php
            ...
            <span class="input-group-addon" style="width:90px"><span class="glyphicon glyphicon-barcode" style="color:orange"></span></span>
              <input type="text" name="codigo" id="codigo" value="" class="form-control" placeholder="Código Asignatura" autofocus autocomplete="off" required>
            </div>
            <div class="form-group input-group" style="width:100%;">
            ...
            <div class="form-group input-group" style="width:100%;">
              <span class="input-group-addon" style="width:90px"><span class="glyphicon glyphicon-file" style="color:orange"></span></span>
              <input type="text" name="nomAsignatura" id="nomAsignatura" value="" class="form-control" placeholder="Nombre Asignatura" autofocus autocomplete="off" required>
            </div>
