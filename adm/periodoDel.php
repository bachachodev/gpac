...
if ((isset($_POST['periID'])) && ($_POST['periID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM periodo WHERE periID=%s",
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <!--tab content-->
            ...
            <input <?php if (!(strcmp($row_rsEdit['periVigencia'],1))) {echo "checked=\"checked\"";} ?> name="vigencia" type="checkbox" class="styled" id="vigencia" value="1" disabled>
