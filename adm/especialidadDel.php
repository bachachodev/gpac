...
if ((isset($_POST['espeID'])) && ($_POST['espeID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM especialidad WHERE espeID=%s",
      ...
      <div class="panel-body">
        ...
        <!--tab content-->
            ...
            <div class="form-group input-group" style="width:100%;">
              ...
              <input type="text" name="especialidad" id="especialidad" value="<?php echo $row_rsEdit['espeNombre']; ?>" class="form-control" placeholder="Nombre Especialidad" autofocus autocomplete="off" disabled>
            </div>
            <div class="checkbox checkbox-warning">
            <input <?php if (!(strcmp($row_rsEdit['espeVigencia'],1))) {echo "checked=\"checked\"";} ?> name="vigencia" type="checkbox" class="styled" id="vigencia" value="1" disabled>
