...
mysql_select_db($database_rsPP, $rsPP);
$query_rsEdit = "SELECT * FROM especialidad";
...
<div class="container col-md-6 col-md-offset-3">
  ...
  <tr>
    <td><?php if ($_SERVER['QUERY_STRING'] == "edit") : ?>
      <a href="especialidadEdit.php?espeCodigo=<?php echo $row_rsEdit['espeCodigo']; ?>" data-toggle="tooltip" data-placement="top" title="Editar" onclick="submitForm()"><span class="glyphicon glyphicon-pencil"></span></a>
      <?php endif; ?>
      <?php if ($_SERVER['QUERY_STRING'] == "del") : ?>
      <a href="especialidadDel.php?espeCodigo=<?php echo $row_rsEdit['espeCodigo']; ?>" data-toggle="tooltip" data-placement="top" title="Editar" onclick="submitForm()"><span class="glyphicon glyphicon-remove"></span></a>
      <?php endif; ?>
    <td><?php echo $row_rsEdit['espeCodigo']; ?></td>
    <td><?php echo $row_rsEdit['espeNombre']; ?></td>
    <td><span class="glyphicon <?php if (($row_rsEdit['espeVigencia']) == 1) { echo "glyphicon-ok"; } else { echo "glyphicon-remove";} ?>" style="text-align:center; color:<?php if (($row_rsEdit['espeVigencia']) == 1) { echo "#0C0"; } else { echo "#F00";} ?>"></span></td>
  </tr>
