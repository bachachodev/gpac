...
if ((isset($_POST['seccID'])) && ($_POST['seccID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM seccion WHERE seccID=%s",
...
<form method="POST" class="form-signin" name="agregar" id="agregar" role="form" autocomplete="off" autofill="off">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <!--tab header-->
        <h3>Eliminar sección (<?php echo $row_rsEdit['seccCodigo']; ?>)</h3>
        <!--tab content-->
            ...
            <select name="especialidad" id="especialidad" class="form-control" title="Especialidad" disabled>
            ...
            <select name="tipo" id="tipo" class="form-control" title="Tipo Sección" disabled>
            ...
            <input <?php if (!(strcmp($row_rsEdit['seccVigencia'],1))) {echo "checked=\"checked\"";} ?> name="vigencia" type="checkbox" class="styled" id="vigencia" value="1" disabled>
